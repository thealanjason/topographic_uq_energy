...
::: {style="display: flex; align-items: flex-start; justify-content: space-between; gap: 20px; width: 100%; margin-top: -10px;"}

::: {style="width: 48%; font-family: 'Poppins', sans-serif;"}

<p style="margin-bottom: 15px; font-size: 22px; color: #333;">
  <strong style="color: #0052a3;">Quantity of Interest:</strong> Water depth at the houses coordinates
</p>
...
<table style="width: 100%; border-collapse: collapse; font-size: 20px; text-align: center; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
  <thead>
    <tr style="background-color: #0052a3; color: white;">
      <th style="padding: 15px; border: 1px solid #dee2e6;">$\sigma_{input}$ (m)</th>
...
![](pres_plots/introduction/water_depth_uq/water_height.gif){style="max-height: 520px; width: auto; object-fit: contain;"}
...
<ul style="list-style-type: disc; padding-left: 40px; margin-left: 0; margin-bottom: 25px;">
  ...
  <li style="margin-bottom: 12px;">Time is being used as a proxy for energy consumption.</li>
</ul>
:::
...
<ul style="list-style-type: disc; padding-left: 40px; margin-left: 0; margin-top: 0px;">
  <li class="fragment" data-fragment-index="0" style="margin-bottom: 35px;">
...
<ul style="list-style-type: disc; padding-left: 60px; margin-top: 0px;">
  <li style="margin-bottom: 40px; font-size: 28px; line-height: 1.5;">
